<template>
   <div id="customer">
                ...
                <div class="card-header">Customer</div>
                   <div>
                       <button type="button" class="btn btn-info" @click="create">Add New <i class="fas fa-plus"></i></button>
                        <button type="button" class="btn btn-primary" @click="reload">Refresh <i class="fas fa-sync"></i></button>
                ...
                <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="tသext-center">Action</th>
    ...
    <div class="modal fade" id="customerModalLong" tabindex="-1" role="dialog"
      ...
      aria-hidden="true" style="background-color:lightblue">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="customerModalLongTitle">{{ editMode ? "Edit" : "Add New" }} Data</h5>
    ...
    <!-- ShowModal -->
    <div class="modal fade" id="showModal" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true" style="background-color:#8DF7AA ">
      <div class="modal-dialog" role="document">
